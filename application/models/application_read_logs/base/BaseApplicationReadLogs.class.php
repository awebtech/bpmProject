...
/**
 * BaseApplicationReadLogs class
 *
 * @author Ilija Studen <ilija.studen@gmail.com>
 */
abstract class BaseApplicationReadLogs extends DataManager {
	 ...
	 *  - limit
	 *
	 * @return one or ApplicationReadLogs objects
	 * @throws DBQueryError
	 */
	function find($arguments = null) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->find($arguments);
	...
	function findAll($arguments = null) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->findAll($arguments);
			//$instance =& ApplicationReadLogs::instance();
	...
	function findOne($arguments = null) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->findOne($arguments);
			//$instance =& ApplicationReadLogs::instance();
	...
	function findById($id, $force_reload = false) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->findById($id, $force_reload);
			//$instance =& ApplicationReadLogs::instance();
	...
	function count($condition = null) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->count($condition);
			//$instance =& ApplicationReadLogs::instance();
	...
	function delete($condition = null) {
		if(isset($this) && instance_of($this, 'ApplicationReadLogs')) {
			...
			return ApplicationReadLogs::instance()->delete($condition);
			//$instance =& ApplicationReadLogs::instance();
