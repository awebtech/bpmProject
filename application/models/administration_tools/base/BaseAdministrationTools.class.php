<?php 
  ...
  */
  abstract class BaseAdministrationTools extends DataManager {
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'AdministrationTools')) {
        ...
        return AdministrationTools::instance()->count($condition);
        //$instance =& AdministrationTools::instance();
    ...
    */
    function paginate($arguments = null, $items_per_page = 10, $current_page = 1) {
      if(isset($this) && instance_of($this, 'AdministrationTools')) {
        ...
        return AdministrationTools::instance()->paginate($arguments, $items_per_page, $current_page);
        //$instance =& AdministrationTools::instance();
