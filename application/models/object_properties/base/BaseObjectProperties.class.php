<?php 
  ...
  */
  abstract class BaseObjectProperties extends DataManager {
    ...
    */
    function findAll($arguments = null) {
      if(isset($this) && instance_of($this, 'ObjectProperties')) {
        ...
        return  ObjectProperties::instance()->findAll($arguments);
        //$instance =&  ObjectProperties::instance();
    ...
    */
    function findOne($arguments = null) {
      if(isset($this) && instance_of($this, 'ObjectProperties')) {
        ...
        return  ObjectProperties::instance()->findOne($arguments);
        //$instance =&  ObjectProperties::instance();
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'ObjectProperties')) {
        ...
        return  ObjectProperties::instance()->findById($id, $force_reload);
        //$instance =&  ObjectProperties::instance();
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'ObjectProperties')) {
        ...
        return  ObjectProperties::instance()->count($condition);
        //$instance =&  ObjectProperties::instance();
