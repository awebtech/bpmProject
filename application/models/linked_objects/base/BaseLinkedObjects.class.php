    ...
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'LinkedObjects')) {
        ...
        return LinkedObjects::instance()->find($arguments);
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'LinkedObjects')) {
        ...
        return  LinkedObjects::instance()->count($condition);
        //$instance =&  LinkedObjects::instance();
    ...
    */
    function paginate($arguments = null, $items_per_page = 10, $current_page = 1) {
      if(isset($this) && instance_of($this, 'LinkedObjects')) {
        ...
        return  LinkedObjects::instance()->paginate($arguments, $items_per_page, $current_page);
        //$instance =&  LinkedObjects::instance();
