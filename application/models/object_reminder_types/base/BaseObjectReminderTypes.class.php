...
abstract class BaseObjectReminderTypes extends DataManager {
	 ...
	 *  - limit
	 *
	 * @return one or ObjectReminderTypes objects
	 * @throws DBQueryError
	 */
	function find($arguments = null) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			...
			return ObjectReminderTypes::instance()->find($arguments);
	...
	function findAll($arguments = null) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			...
			return ObjectReminderTypes::instance()->findAll($arguments);
			//$instance =& ObjectReminderTypes::instance();
	 ...
	 * @access public
	 * @param array $arguments
	 * @return ObjectReminderType
	 */
	function findOne($arguments = null) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			return parent::findOne($arguments);
		} else {
			return ObjectReminderTypes::instance()->findOne($arguments);
			//$instance =& ObjectReminderTypes::instance();
	...
	function findById($id, $force_reload = false) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			...
			return ObjectReminderTypes::instance()->findById($id, $force_reload);
			//$instance =& ObjectReminderTypes::instance();
	...
	function count($condition = null) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			...
			return ObjectReminderTypes::instance()->count($condition);
			//$instance =& ObjectReminderTypes::instance();
	...
	function delete($condition = null) {
		if(isset($this) && instance_of($this, 'ObjectReminderTypes')) {
			...
			return ObjectReminderTypes::instance()->delete($condition);
			//$instance =& ObjectReminderTypes::instance();
