<?php 
  ...
  /**
  * BillingCategories class
 *
 * @author Carlos Palma <chonwil@gmail.com>
 */
  abstract class BaseBillingCategories extends DataManager {
    ...
    *  - limit
    * 
    * @return one or BillingCategories objects
    * @throws DBQueryError
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        ...
        return BillingCategories::instance()->find($arguments);
    ...
    * @return one or more BillingCategories objects
    */
    function findAll($arguments = null) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        return parent::findAll($arguments);
      } else {
        return BillingCategories::instance()->findAll($arguments);
        //$instance =& BillingCategories::instance();
    ...
    */
    function findOne($arguments = null) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        ...
        return BillingCategories::instance()->findOne($arguments);
        //$instance =& BillingCategories::instance();
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        ...
        return BillingCategories::instance()->findById($id, $force_reload);
        //$instance =& BillingCategories::instance();
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        ...
        return BillingCategories::instance()->count($condition);
        //$instance =& BillingCategories::instance();
    ...
    */
    function delete($condition = null) {
      if(isset($this) && instance_of($this, 'BillingCategories')) {
        ...
        return BillingCategories::instance()->delete($condition);
        //$instance =& BillingCategories::instance();
