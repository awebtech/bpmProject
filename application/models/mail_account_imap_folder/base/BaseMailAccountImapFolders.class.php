<?php 
  ...
  */
  abstract class BaseMailAccountImapFolders extends DataManager {
    ...
    */
    function getPkColumns() {
      return array('account_id', 'folder_name');
    } // getPkColumns
    ...
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->find($arguments);
    ...
    */
    function findAll($arguments = null) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->findAll($arguments);
        //$instance =& MailAccounts::instance();
    ...
    */
    function findOne($arguments = null) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->findOne($arguments);
        //$instance =& MailAccounts::instance();
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->findById($id, $force_reload);
        //$instance =& MailAccounts::instance();
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->count($condition);
        //$instance =& MailAccounts::instance();
    ...
    */
    function delete($condition = null) {
      if(isset($this) && instance_of($this, 'MailAccountImapFolders')) {
        ...
        return MailAccountImapFolders::instance()->delete($condition);
        //$instance =& MailAccounts::instance();
