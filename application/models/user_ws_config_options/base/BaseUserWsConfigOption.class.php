<?php
  ...
  /**
  * BaseUserWsConfigOption class
  *
  * @author Marcos Saiz <marcos.saiz@fengoffice.com>
  */
  abstract class BaseUserWsConfigOption extends DataObject {
    ...
    */
    function manager() {
      if(!($this->manager instanceof UserWsConfigOptions)) $this->manager = UserWsConfigOptions::instance();
      return $this->manager;
    } // manager
  
  } //  BaseUserWsConfigOption 
