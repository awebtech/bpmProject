<?php 
  ...
  */
  abstract class BaseUserWsConfigOptionValues extends DataManager {
    ...
    * @static
    */
    static private $columns = array('option_id' => DATA_TYPE_INTEGER,'option_id' => DATA_TYPE_INTEGER,
    		'workspace_id' => DATA_TYPE_INTEGER,'user_id' => DATA_TYPE_INTEGER,'value' => DATA_TYPE_STRING);
    ...
    */
    function getPkColumns() {
      return array('option_id','user_id','workspace_id');
    } // getPkColumns
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'UserWsConfigOptionValues')) {
        ...
        return UserWsConfigOptionValues::instance()->count($condition);
        //$instance =& ConfigOptions::instance();
    ...
    */
    function instance() {
      static $instance;
      if(!instance_of($instance, 'UserWsConfigOptionValues')) {
        $instance = new UserWsConfigOptionValues();
      } // if
      return $instance;
    } // instance
  
  } // BaseUserWsConfigOptionValues 
