...
abstract class BaseCronEvents extends DataManager {
	...
	static private $columns = array(
		...
		'recursive' => DATA_TYPE_BOOLEAN,
		'delay' => DATA_TYPE_INTEGER,
	...
	function findAll($arguments = null) {
		if(isset($this) && instance_of($this, 'CronEvents')) {
			...
			return CronEvents::instance()->findAll($arguments);
		} // if
	} // findAll
	...
	function findOne($arguments = null) {
		if(isset($this) && instance_of($this, 'CronEvents')) {
			...
			return CronEvents::instance()->findOne($arguments);
		} // if
	} // findOne
	...
	function count($condition = null) {
		if(isset($this) && instance_of($this, 'CronEvents')) {
			...
			return CronEvents::instance()->count($condition);
		} // if
	} // count
