<?php 
  ...
  */
  abstract class BaseObjectReminders extends DataManager {
    ...
    *  - limit
    * 
    * @return one or ObjectReminders objects
    * @throws DBQueryError
    */
    function find($arguments = null) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->find($arguments);
    ...
    */
    function findAll($arguments = null) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->findAll($arguments);
        //$instance =& ObjectReminders::instance();
    ...
    */
    function findOne($arguments = null) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->findOne($arguments);
        //$instance =& ObjectReminders::instance();
    ...
    */
    function findById($id, $force_reload = false) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->findById($id, $force_reload);
        //$instance =& ObjectReminders::instance();
    ...
    */
    function count($condition = null) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->count($condition);
        //$instance =& ObjectReminders::instance();
    ...
    */
    function delete($condition = null) {
      if(isset($this) && instance_of($this, 'ObjectReminders')) {
        ...
        return ObjectReminders::instance()->delete($condition);
        //$instance =& ObjectReminders::instance();
