 ...
 */
abstract class BaseMailDatas extends DataManager {
	...
	function __construct() {
		Hook::fire('object_definition', 'MailData', self::$columns);
		parent::__construct('MailData', 'mail_datas', true);
	} // __construct
	 ...
	 *  - limit
	 *
	 * @return one or MailDatas objects
	 * @throws DBQueryError
	 */
	function find($arguments = null) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->find($arguments);
	...
	function findAll($arguments = null) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->findAll($arguments);
			//$instance =& MailDatas::instance();
	...
	function findOne($arguments = null) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->findOne($arguments);
			//$instance =& MailDatas::instance();
	...
	function findById($id, $force_reload = false) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->findById($id, $force_reload);
			//$instance =& MailDatas::instance();
	...
	function count($condition = null) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->count($condition);
			//$instance =& MailDatas::instance();
	...
	function delete($condition = null) {
		if(isset($this) && instance_of($this, 'MailDatas')) {
			...
			return MailDatas::instance()->delete($condition);
			//$instance =& MailDatas::instance();
