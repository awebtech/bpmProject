...
<?php tpl_display(get_template_path('form_errors')) ?>
  ...
  <div id="forgotPasswordSubmit"><?php echo submit_button(lang('email me my password')) ?><span>(<a class="internalLink" href="<?php echo get_url('access', 'login') ?>"><?php echo lang('login') ?></a>)</span></div>
</form>