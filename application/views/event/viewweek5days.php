...
?>
											<script>
												...
												addTip('w5_ev_div_' + '<?php echo $event->getId() . $id_suffix ?>', <?php echo json_encode(clean($event->getSubject())) ?>, <?php echo json_encode($tipBody);?>);
											</script>
<?php
											$bold = "bold";
...
?>
						...
						<div style="height:100%;border-left: 1px solid;border-right: 1px solid;border-color:<?php echo $border_color ?>;">
							<table style="width:100%;"><tr><td>
								...
								<a href='<?php echo get_url('event', 'viewevent', array(
										'view' => 'viewweek5days',
										'id' => $event->getId(),
										'user_id' => $user_filter
									)); ?>'
