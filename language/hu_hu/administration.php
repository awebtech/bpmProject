...
return array(
  ...
  'config option desc user_email_fetch_count' => 'Hány levelet töltsön le a rendszer, ha a felhasználó a "Levélfiókok ellenőrzése" gombra kattint. Nagy érték használatakor időtúllépési hibák léphetnek fel. Adjon meg 0-t a korlát kikapcsolásához. Figyelem, ez nem befolyásolja a cron-on keresztüli email letöltést.',
	...
	'user ws config category name calendar panel' => 'A Naptár beállításai',
 	'user ws config option name show pending tasks widget' => 'Mutassa a függő feladatok kisalkalmazást',
	'user ws config option name pending tasks widget assigned to filter' => 'Mutassa a hozzá rendelt feladatokat',
	'user ws config option name show late tasks and milestones widget' => 'Mutassa a késében lévő feladatok és mérföldkövek kisalkalmazást',
	'user ws config option name show messages widget' => 'Mutassa a feljegyzések kisalkalmazást',
	'user ws config option name show comments widget' => 'Mutassa a megjegyzések kisalkalmazást',
	'user ws config option name show documents widget' => 'Mutassa a dokumentumok kisalkalmazást',
	'user ws config option name show calendar widget' => 'Mutassa a mini naptár kisalkalmazást',
	'user ws config option name show charts widget' => 'Mutassa a grafikonok kisalkalmazást',
	'user ws config option name show emails widget' => 'Mutassa a email üzenetek kisalkalmazást',
 	'user ws config option name show dashboard info widget' => 'Mutassa a munkaasztal kisalkalmazást',
 	'user ws config option name show getting started widget' => 'Mutassa a kezdő lépések kisalkalmazást',

	'user ws config option name localization' => 'Nyelv megadása',
	'user ws config option desc localization' => 'A feliratok és dátumok a megadott nyelven fognak megjelenni. Frissítse a böngésző lapját!',
	'user ws config option name initialWorkspace' => 'Kezdő Projekt',
	'user ws config option desc initialWorkspace' => 'A belépése után ez a projekt lesz kiválasztva, vagy beállíthatja, hogy a legutóbb használt legyen kiválasztva.',
	'user ws config option name rememberGUIState' => 'Emlékezzen a kezelői felület helyzetére',
	'user ws config option desc rememberGUIState' => 'Beállíthatja, hogy emlékezzen a kezelői felület beállításaira (panel méretek, becsukott/kinyitott állapotuk, stb). Figyelem! Ez még BÉTA állapotú!',
	'user ws config option name time_format_use_24' => '24 órás idő megjelenítés',
	'user ws config option desc time_format_use_24' => 'Ha engedélyezi: \'hh:mm\' formában 00:00-tól 23:59-ig fogja az időt megjeleníteni, ha nem; 1-től 12-ig.',
	'user ws config option name work_day_start_time' => 'Munkanap kezdete',
	'user ws config option desc work_day_start_time' => 'Hány órától kezd dolgozni.',
	
	'user ws config option name show dashboard info widget' => 'Mutassa a projekt leírás kisalkalmazást',

	'user ws config option name my tasks is default view' => 'Az Önhöz rendelt feladatok az alap beállítás',
	'user ws config option desc my tasks is default view' => 'Ha nem állítja ezt be, alapból az összes feladatot látni fogja',
	'user ws config option name show tasks in progress widget' => 'Mutassa a \'Végrehajtás alatt lévő feladatok\' kisalkalmazást',
	'user ws config option name can notify from quick add' => 'A feladat értesítő legyen bekapcsolva alapból',
	'user ws config option desc can notify from quick add' => 'Az értesítő lehetővé teszi, hogy értesítést küldjön a felhasználónak a feladat hozzárendelése vagy módosítása esetére',
	
	'user ws config option name show_tasks_context_help' => 'Feladatokhoz helyérzékeny súgó megjelenítése',
  'user ws config option desc show_tasks_context_help' => 'Ha engedélyezett, súgó fog megjelenni a feladatok panelen.',
 	'user ws config option name start_monday' => 'A hét első napja hétfő',
	'user ws config option desc start_monday' => 'A hét első napja hétfő legyen (az oldal frissítése szükséges az életbe lépéshez)',
  'user ws config option name show_week_numbers' => 'Hetek száma legyen látható',
	'user ws config option desc show_week_numbers' => 'Hetek száma legyen látható a heti és a havi nézetekben.',
  
  	'user ws config option name date_format' => 'Dátum formátum',
  	'user ws config option desc date_format' => 'Sablon a dátumok megjelenéséhez.',
  	'user ws config option name descriptive_date_format' => 'Beszédes dátum formátum',
  	'user ws config option desc descriptive_date_format' => 'Sablon a beszédesebb dátumok megjelenéséhez.',

  	'user ws config option name show_context_help' => 'Helyérzékeny súgó bekapcsolása',
  	'user ws config option desc show_context_help' => 'Válassza ki a kívánt beállítást (mindíg, bezárásig, soha).',
  ...
  'start backup' => 'Biztonsági mentés folyamatának elindítása',
	...
	'user ws config option name always show unread mail in dashboard' => 'Mindig mutassa a Vezérlőpulton a még nem olvasott leveleket',
	'user ws config option desc always show unread mail in dashboard' => 'Ha a "Nem" van kiválasztva, az aktív projekt üzeneteit láthatja',
  ...
  'custom properties updated' => 'Egyedi tulajdonságok frissítve',
 	'user ws config option name noOfTasks' => 'Adja meg a megjelenő feladatok számát',
