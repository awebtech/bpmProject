<?php
	...
	'user ws config category name calendar panel' => 'カレンダーオプション',
	'user ws config category name mails panel' => 'メールオプション',
	...
	'user ws config option name show workspace widget' => 'ワークスペースの説明ウィジェットを表示', // user ws config option name show dashboard info widget -> Show workspace information widget
