<?php return array(
	...
	'user ws config option name attach_docs_content' => 'Прикреплять файлы к содержимому',
	...
	'user ws config option name create_contacts_from_email_recipients' => 'Создавать контакты из получателей сообщения',
	'user ws config option desc create_contacts_from_email_recipients' => 'Когда этот параметр установлен в положение "Да", то контакты будут автоматически создаваться для каждого отправленного адреса электронной почты. У Вас должно быть разрешение "Управлять всеми контактами".',
	'user ws config option name drag_drop_prompt' => 'Действия при перетаскивании объекта в рабочей области',
	'user ws config option desc drag_drop_prompt' => 'Выбрать, какие действия следует предпринять при перетаскивании объекта в рабочей области.',
	...
	'user ws config option name mail_drag_drop_prompt' => 'Классификация вложений электронной почты при перетаскивание?',
	'user ws config option desc mail_drag_drop_prompt' => 'Выбрать то, что должно быть сделано с вложениями электронной почты при перетаскивании в проект.',
	...
	'user ws config option name show_emails_as_conversations' => 'Показать электронную переписку как разговор',
	'user ws config option desc show_emails_as_conversations' => 'Если включена, то сообщения электронной почты, будут объединены в листинг Emails, показаны все сообщения, принадлежащие к одной нити (ответы, форварды, и т.д.) как одна запись в списке.',
	'user ws config option name autodetect_time_zone' => 'Автоматически определять часовой пояс',
	...
	'user ws config option name classify_mail_with_conversation' => 'Классифицировать почту с ',
	'user ws config option name mail_account_err_check_interval' => 'Интервал проверки учетных записей почты на ошибки',
	'user ws config option desc mail_account_err_check_interval' => 'Интервал между каждой проверки учетной записи почты (0 для отключения)',
	'user ws config option desc classify_mail_with_conversation' => 'Если включено, принятая почта классифицируется по проектам (если письмо относится к этому проекту).',
); ?>
